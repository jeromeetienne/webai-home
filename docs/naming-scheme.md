...
- The worker source file that implements the computations of one domain is named after those computations: [`packages/worker_webpage/web/src/stage_dev_formula_helper.ts`](../packages/worker_webpage/web/src/stage_dev_formula_helper.ts), [`packages/worker_webpage/web/src/stage_llm_qwen3_0_6b_helper.ts`](../packages/worker_webpage/web/src/stage_llm_qwen3_0_6b_helper.ts), and [`packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts`](../packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts).
