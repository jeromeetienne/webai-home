...
There is a safety bound of 400 pieces per answer, defined in [`packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts`](../packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts), so a model that never finished an answer could not keep the stage running for as long as the page stays open.
...
- The formula computations: [`packages/worker_webpage/web/src/stage_dev_formula_helper.ts`](../packages/worker_webpage/web/src/stage_dev_formula_helper.ts).
- The language-model shard computation: [`packages/worker_webpage/web/src/stage_llm_qwen3_0_6b_helper.ts`](../packages/worker_webpage/web/src/stage_llm_qwen3_0_6b_helper.ts).
- The computation that uses the language model built into the browser: [`packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts`](../packages/worker_webpage/web/src/stage_llm_gemma_nano_chrome_helper.ts).
