...
- A task whose worker is not a browser tab has no debug page, because those pages exist to open worker browser tabs inside inline frames. `task_llm_llama3_2_3b_full` is run by the Node.js worker in [`packages/worker_openai`](../packages/worker_openai), which is started from a command line instead, so no `/debug_iframe_llm_llama3_2_3b_full` page exists.
...
- The worker source file that implements the computations of one domain is named after those computations, as `stage_helper_{task_suffix}.ts`: [`packages/worker_webpage/web/src/stages/stage_helper_dev_formula.ts`](../packages/worker_webpage/web/src/stages/stage_helper_dev_formula.ts), [`packages/worker_webpage/web/src/stages/stage_helper_llm_qwen3_0_6b_sharded.ts`](../packages/worker_webpage/web/src/stages/stage_helper_llm_qwen3_0_6b_sharded.ts), [`packages/worker_webpage/web/src/stages/stage_helper_llm_gemma_nano_chrome_full.ts`](../packages/worker_webpage/web/src/stages/stage_helper_llm_gemma_nano_chrome_full.ts), and [`packages/worker_webpage/web/src/stages/stage_helper_llm_qwen3_5_0_8b_full.ts`](../packages/worker_webpage/web/src/stages/stage_helper_llm_qwen3_5_0_8b_full.ts). A worker that is not a browser names its own stage files the same way, in its own package: [`packages/worker_openai/src/stages/stage_helper_llm_llama3_2_3b_full.ts`](../packages/worker_openai/src/stages/stage_helper_llm_llama3_2_3b_full.ts).
