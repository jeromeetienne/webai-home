...
/** The options shared by all three subcommands, exactly as commander parses them. */
export type RawSharedOptions = {
...
export class SharedOptions {
	 ...
	 */
	static buildTarget(rawOptions: RawSharedOptions): CompletionTarget {
		return {
