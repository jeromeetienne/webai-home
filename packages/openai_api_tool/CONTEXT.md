...
- `completion` and `history` reject a model name outside those lists; `benchmark` passes an outside name through unchanged, because it measures endpoints this project has no list of.
