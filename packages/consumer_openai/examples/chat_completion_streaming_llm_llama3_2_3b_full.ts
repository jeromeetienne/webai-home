...
// Run with:
//   npm run example:chat_completion_streaming_llm_llama3_2_3b_full --workspace @webai/consumer-openai
//
...
// the pipeline can manage, which `examples/chat_completion_llm_llama3_2_3b_full.ts` shows.
