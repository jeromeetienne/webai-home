...
// Run with:
//   npm run example:chat_completion_llm_qwen3_5_0_8b_full --workspace @webai/consumer-openai
//
...
// which `examples/chat_completion_streaming_llm_qwen3_5_0_8b_full.ts` shows.
