...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
//	Real llm_qwen3_5_0_8b_full test — the OpenAI-compatible server against a real browser worker
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////

// Run with: npm run test:real:llm_qwen3_5_0_8b_full --workspace @webai/consumer-openai
// Or: npm run test:real:llm_qwen3_5_0_8b_full:headed --workspace @webai/consumer-openai, to watch the browser
...
// OpenAI-compatible server, opens the gateway's `/debug_iframe_llm_qwen3_5_0_8b_full` page in a dedicated
// Chrome process to set up the one worker browser tab the Qwen3.5-0.8B full-model stage needs, then submits a
...
// complete model — about 584 megabytes of weights plus a 19 megabyte tokenizer, pinned to revision
// c0d619322dad7c4441a8841a53fc59772ddddcc0 of onnx-community/Qwen3.5-0.8B-ONNX — the first time it runs, which
// measured about 163 seconds in testing and is why setup here is given as long a timeout as the sharded Qwen3
// test's.
//
...
const realTestHelper = new RealTestHelper({
	debugPath: '/debug_iframe_llm_qwen3_5_0_8b_full',
