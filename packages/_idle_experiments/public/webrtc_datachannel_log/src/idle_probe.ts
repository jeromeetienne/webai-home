...
//	compute speed do while a loopback WebRTC data channel stays open, for
//	comparison against the silent baseline measured by visibility_timer_log
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////

/**
 * Identical in method to `visibility_timer_log/src/idle_probe.ts`, kept as its own copy so the
 * only thing that differs between the two experiments is whether {@link WebrtcLoopback} is
 * running — everything else about how the measurement is taken stays the same.
 */

/** What kind of measurement one log row reports. */
export type LogRowKind = 'visibility' | 'focus' | 'timer' | 'raf' | 'cpu' | 'webrtc';
...
/** Loop iterations per benchmark run, identical to the other experiments' so all are directly comparable. */
